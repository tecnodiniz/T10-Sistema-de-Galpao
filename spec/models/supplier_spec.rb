...
RSpec.describe Supplier, type: :model do
  ...
  describe '#full_description' do
    it 'Exibe nome e CNPJ' do
      s = Supplier.new(corporate_name: 'ACME LTDA', brand_name: 'ACME', registration_number: '0303698900181',
                       full_address: 'Av das Palmas, 1200', city: 'Bauru', state: 'SP', email: 'acme@yahoo.com.br')

      result = s.full_description

      expect(result).to eq 'ACME LTDA - 0303698900181'
    end
  end
end
